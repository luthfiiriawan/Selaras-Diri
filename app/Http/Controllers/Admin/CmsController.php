...
class CmsController extends Controller
{
    ...
    {
        Psychologist::query()->create($this->validatePsychologist($request));
    ...
    {
        $psychologist->update($this->validatePsychologist($request));
    ...
    {
        Event::query()->create($this->validateEvent($request));
